...
namespace StarterAssets { 
    public partial class @StarterAssets: IInputActionCollection2, IDisposable
    {
        ...
        ""maps"": [
            ...
            {
                ""name"": ""Units"",
                ""id"": ""b735699a-a3ed-4b68-a2c3-8207a4d98871"",
                ""actions"": [
                    {
                        ""name"": ""Forward(Single)"",
                        ""type"": ""Button"",
                        ""id"": ""f6da2219-c699-42d7-acaf-725aaa6621b9"",
                        ""expectedControlType"": ""Button"",
                        ""processors"": """",
                        ""interactions"": ""Press"",
                        ""initialStateCheck"": false
                ...
                ""bindings"": [
                    {
                        ""name"": """",
                        ""id"": ""d7b79398-4d2c-440a-8fc8-01aa13181db6"",
                        ""path"": ""<Keyboard>/q"",
                        ""interactions"": """",
                        ""processors"": """",
                        ""groups"": """",
                        ""action"": ""Forward(Single)"",
                        ""isComposite"": false,
                        ""isPartOfComposite"": false
                    }
                ]
        ...
        ""controlSchemes"": [
            ...
            m_Units_ForwardSingle = m_Units.FindAction("Forward(Single)", throwIfNotFound: true);
        }
        ...
        private readonly InputAction m_Units_ForwardSingle;
        public struct UnitsActions
        {
            private @StarterAssets m_Wrapper;
            public UnitsActions(@StarterAssets wrapper) { m_Wrapper = wrapper; }
            public InputAction @ForwardSingle => m_Wrapper.m_Units_ForwardSingle;
            ...
            public void AddCallbacks(IUnitsActions instance)
            {
                ...
                @ForwardSingle.started += instance.OnForwardSingle;
                @ForwardSingle.performed += instance.OnForwardSingle;
                @ForwardSingle.canceled += instance.OnForwardSingle;
            }
        ...
        {
            void OnForwardSingle(InputAction.CallbackContext context);
        }
    }
}